                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12" value="{{$visitor->name}}">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="nis" name="nis" required="required" class="form-control col-md-7 col-xs-12" value="{{$visitor->nis}}">
                      </div>
                    </div>
...
<script>
 $(document).ready(function(){
    ...
    $("#btnUpdate").click(function(event) {
      ...
      $.ajax({
        url: '{{route("visitors.update",['id' => $visitor->id])}}', // url edit data
        dataType: 'JSON',
        type: 'PUT',
        ...
        success: function( data, textStatus, jQxhr ){
            ...
            showNotifSuccess();
            // kembali kelist book
            window.location.href = '{{route("page.list-visitors")}}'
        },
